# 我的 Codex 实操笔记——把一个行业弄明白

![我的Codex实操笔记](../assets/covers/公众号横版封面_2350x1000.png)

把一个行业弄明白，我的标准是三句话能说出口：需求从哪儿来，利润留在谁手里，现在的价格反映了多少期待。而且这三句，每一句都要指得出证据在哪。

这篇是我把这件事拆成十五道工序、一道道交给 Codex 的完整记录——找资料、核口径、建证据表、做公司比较、跑情景测算、写一页判断。每一道都附上我实际用的指令，可以直接复制。

一份年报可能有几百页，几家公司的披露口径各有差别，行业数据散在统计公报、协会资料和新闻里。把它们凑齐需要耐心，把它们串起来更需要判断。这些活我交给 Codex 做，自己留下四件事：定问题、查关键证据、解释结果、决定下一步查什么。
...
（正文中的［n］对应下面编号。公众号正文里的链接不可点，复制到浏览器打开即可）
...
你要是照着走了一遍，欢迎回来说说卡在哪一步。卡住的地方，往往比顺利的地方更值得写一篇。
